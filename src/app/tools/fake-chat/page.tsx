...
export default function FakeChatStudioPage() {
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col">
      ...
      <header className="border-b border-zinc-800 bg-zinc-900/60 backdrop-blur-md sticky top-0 z-50 px-6 py-3.5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400">
              Generador de capturas carrusel y vídeos animados para redes sociales
            </p>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center gap-2 text-xs">
          <span className="text-zinc-500 mr-2 font-medium">Plataformas nativas:</span>
          <span className="px-2.5 py-1 rounded-lg bg-zinc-800 text-purple-300 font-semibold border border-purple-500/30">
            Instagram DM
          </span>
          <span className="px-2.5 py-1 rounded-lg bg-zinc-800 text-emerald-300 font-semibold border border-emerald-500/30">
            WhatsApp
          </span>
          <span className="px-2.5 py-1 rounded-lg bg-zinc-800 text-blue-300 font-semibold border border-blue-500/30">
            iMessage
          </span>
        </div>
      </header>
