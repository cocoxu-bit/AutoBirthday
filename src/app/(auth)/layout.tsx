export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen bg-gradient-festive flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Gradient blobs */}
      <div className="absolute -top-40 -left-40 w-80 h-80 bg-emerald-300/20 rounded-full blur-3xl" />
      <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-teal-300/20 rounded-full blur-3xl" />
